...
class CreateArticle extends Component
{
    ...
    public function create()
    {
        ...
        $imagePath = $this->coverImage($validated['image'], 800, 800, 'images/posts');
        try {
            $post = Post::create($validated);
            $post->imageable()->create(['url' => $imagePath, 'type' => 'post thumbnail']);
    ...
    public function render()
    {
        ...
        return view('pages.dashboard.create-article', compact('categories', 'tags'))
