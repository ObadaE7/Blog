...
class TagTable extends Component
{
    ...
    {
        $columns = ['id', 'name', 'slug', 'articles_count'];
        ...
        $rows = Tag::withCount('articles')
            ->when($this->searchBy === 'articles_count', function ($query) {
                $query->having('articles_count', 'like', "%{$this->search}%");
            }, function ($query) {
