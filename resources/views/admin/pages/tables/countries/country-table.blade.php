@section('breadcrumb')
    <x-breadcrumb>
        <li class="breadcrumb-item"><a href="{{ route('admin.countries') }}">@lang('dashboard.table.Table')</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a>@lang('dashboard.table.Countries')</a></li>
    </x-breadcrumb>
@endsection
                    ...
                    <tr wire:key="{{ $row->id }}">
                        ...
                        <td>
                            <img src="{{ asset($row->imageable ? 'storage/' . $row->imageable->url : '') }}"
                                class="table__img-flag" alt="{{ $row->name }}">
                        </td>
                        <td>{{ $row->name }}</td>
                        <td>
