@section('breadcrumb')
    <x-breadcrumb>
        <li class="breadcrumb-item"><a href="{{ route('admin.roles') }}">@lang('dashboard.table.Table')</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a>@lang('dashboard.table.Roles')</a></li>
    </x-breadcrumb>
@endsection

<section class="table__wrapper">
    <div class="table__filter">
        <x-table-filter :columns="$columns" :searchBy="$searchBy" :perPages="$perPages" optCreate="true" />
    </div>
