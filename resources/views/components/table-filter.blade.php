<div class="filter__options">
    <div class="dropdown">
        <button class="btn btn-danger btn__options text-end rounded-1" type="button" data-bs-toggle="dropdown"
            aria-expanded="false">
            @lang('dashboard.table.Options')
        </button>
        <ul class="dropdown-menu dropdown-menu-start text-end">
                ...
                <li>
                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#createModal">
                        <div class="d-flex align-items-center gap-2">
                            <span class="material-symbols-outlined text-muted">add</span>
            ...
            <li>
                <button wire:click='$refresh' class="dropdown-item">
                    <div class="d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-muted fs-5">refresh</span>
            ...
            <li>
                <button wire:click='resetFilters' class="dropdown-item">
                    <div class="d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-muted fs-5">youtube_searched_for</span>
            ...
            <li>
                ...
                <div class="dropdown-item-text">
                    <div class="d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-muted fs-5">file_download</span>
            ...
            <li>
                <button class="dropdown-item" disabled>
                    <div class="d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-muted fs-5">description</span>
            ...
            <li>
                <button class="dropdown-item" disabled>
                    <div class="d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-muted fs-5">print</span>
...
<div class="filter__search">
    <button class="btn btn-danger btn__search" type="button" data-bs-toggle="dropdown" aria-expanded="false"></button>
...
<div class="filter__per-page">
    <select wire:model.live='perPage' class="form-select rounded-1">
